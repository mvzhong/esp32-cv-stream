...
#define CAMERA_MODEL_XIAO_ESP32S3 // Define to use configuration from camera_pins.h
...
String serverDomain = "***";  // Replace with IP/domain name of CV service server
...
// Setup LED FLash if LED pin is defined in camera_pins.h
  ...
  // Note: reflecting my image over x-axis because my ESP32 controller is easier to use upside-down.
  // Comment out this line if you don't want the image reflected.
  s->set_vflip(s, 1);
